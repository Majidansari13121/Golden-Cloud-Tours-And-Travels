...
var Ab = function(a, b, c) {
    return h(function*() {
        ...
        const e = d
          , f = new ib(e,a.g.btoa);
        return zb(a, a.g.performance.now(), (e == null ? void 0 : e.id) || "undefined", !0, f.encrypt(b))
    })
}
  , Bb = function(a, b, c) {
    return h(function*() {
        return zb(a, a.g.performance.now(), "unknown", !1, pb(c.encryptionKeyString || "").encryptMessage(b).then(d => ({
